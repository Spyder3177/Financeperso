...
export default function TransactionList({ transactions, accounts, onDelete, onUpdate, onImport }) {
  ...
  // Transactions filtrées par compte (les transactions sans account vont dans le premier compte par défaut)
                ...
                <div className="flex items-center gap-3 px-4 py-3">
                  ...
                  <div className="flex items-center gap-1 shrink-0">
                    ...
                    <button
                      ...
                      className="text-slate-300 hover:text-blue-400 p-1 rounded-lg transition-all"
                      title="Modifier"
                    >
                      <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
